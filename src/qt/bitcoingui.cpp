...
setStyleSheet("QMainWindow{border-image: url(:/images/background)  0 0 0 0 stretch stretch;} QPushButton{background-color: rgba(255, 255, 255, 0);}  QToolButton:!hover{background-color:rgb(10,90,32);}");
